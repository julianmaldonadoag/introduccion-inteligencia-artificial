...
from collections import deque # Se utilizara para crear la pila.
import time
...
# Solución para el 8-puzzle usando DFS.
def DFS(initial_state, empty_pos, goal_state):
    ...
    while frontier:
        state = frontier.pop() # Sale el ultimo nodo en entrar.
...
tracemalloc.start()
if (DFS(initial_state, empty_pos, goal_state)):
    end_time = time.time()
    print("Objetivo encontrado aplicando DFS")
